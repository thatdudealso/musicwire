...
export const config = {
  ...
  audioTailAllowanceSeconds: decimal('AUDIO_TAIL_ALLOWANCE_SECONDS', 3),
  sustainedAudioTailAllowanceSeconds: decimal('AUDIO_SUSTAINED_TAIL_ALLOWANCE_SECONDS', 3.25),
